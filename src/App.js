...
class App extends Component {
    ...
    handleSearchChange = (e) => this.setState({search: e.target.value.toLowerCase()});
    ...
    render() {
        ...
        return (
            <div>
                <header>
                    <div className="container">
                        ...
                        <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="poo" role="img"
                             ...
                             className="svg-inline--fa fa-poo fa-w-16 fa-7x">
                            <g>
                ...
                {subject!=='' && <Fragment>
                        <div id="search-box">
                            <input onChange={this.handleSearchChange} value={search} type="search" name="search"
                                   placeholder="Search for a Question" autoComplete="true" autoFocus/>
                        </div>

                        <QuestionList questionsData={QuestionsData[subject]} searchTerm={search}/>
                    </Fragment>
                }
